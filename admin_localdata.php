...
if (isset($_POST['submit'])) {
	...
	$user = $_POST['username'];
	$pas = $_POST['password'];
	$sql1 = mysqli_query($con, "SELECT * FROM pharmacist WHERE username='$user'") or die("Eroror");
...
<body>
	<div id="content">
		...
		*/
							...
							$result = mysqli_query($con, "SELECT * FROM pharmacist ") or die("Eroror");
							if ($selected_val == "All")
								$result = mysqli_query($con, "SELECT * FROM pharmacist") or die("Eroror");
							if ($selected_val == "Fullerton")
								$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Fullerton' ") or die("Eroror");
							if ($selected_val == "Michikan")
								$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Michikan' ") or die("Eroror");
							if ($selected_val == "Newark")
								$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Newark' ") or die("Eroror");
							if ($selected_val == "Ladora")
								$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE postal_address='Ladora' ") or die("Eroror");
