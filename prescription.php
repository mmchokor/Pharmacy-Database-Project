...
<body>
	<div id="content">
		...
		*/
						...
						$result = mysqli_query($con, "SELECT * FROM prescription") or die("Error");
						...
						<div id="table_1">
							...
							<form name="myform" onsubmit="return validateForm(this);" action="invoice.php" method="post">
								<table width="200" height="106" border="0">
									<tr>
										<td align="left"><input name="customer_name" placeholder="Customer ID" id="customer_id" type="text" style="width:170px" required="required" /></td>
									</tr>
									<tr>
