...
<body>
	<div id="content">
		...
		*/
							...
							$result = mysqli_query($con,"SELECT * FROM stock_np UNION ALL SELECT * FROM stock_ca UNION ALL SELECT * FROM stock_dr  order by stock_id")  or die("Erorr");

							if ($selected_val == "All")
								$result = mysqli_query($con,"SELECT * FROM stock_np UNION ALL SELECT * FROM stock_ca UNION ALL SELECT * FROM stock_dr  order by stock_id")  or die("Error");
